...
export class QuotePageComponent {
  ...
  readonly projectFields = [
    ...
    { label: 'Country', type: 'select', placeholder: 'Select your country', iconName: 'public' },
    { label: 'Tent Category', type: 'select', placeholder: 'Select tent category', iconName: 'category' },
    { label: 'Project Location', type: 'text', placeholder: 'Enter project location', iconName: 'location_on' },
    { label: 'Estimated Quantity', type: 'text', placeholder: 'Enter estimated quantity', iconName: 'format_list_numbered' },
    { label: 'Project Timeline', type: 'select', placeholder: 'Select timeline', iconName: 'date_range' }
  ];
