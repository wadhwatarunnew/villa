...
@Component({
  ...
  standalone: true,
  imports: [TentDetailBannerComponent, TentOverviewComponent, TentFeaturesComponent, CommonCtaComponent, RelatedTentsSliderComponent, TentImageGalleryComponent],
...
export class TentDetailPageComponent {
  ...
  constructor(route: ActivatedRoute) {
    route.paramMap.subscribe(params => {
      ...
      this.tent = this.category.tents.find(item => item === params.get('tent')) ?? this.category.tents[0];
